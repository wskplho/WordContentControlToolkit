...
{	
	...
	{  
		...
		{
            MessageBox.Show(msg, Program.Dbe.AppName, MessageBoxButtons.OK, MessageBoxIcon.Error);
		}
        
        public static void ShowSimpleMsgBoxWarning(string msg)
		{
            MessageBox.Show(msg, Program.Dbe.AppName, MessageBoxButtons.OK, MessageBoxIcon.Warning);
		}

		public static void ShowSimpleMsgBoxInfo(string msg)
		{
			MessageBox.Show(msg, Program.Dbe.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
		}
	}
}
